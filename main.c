...
char *branch[] = {"Computer Science and Engineering", "Electronics & Communication", "Mechanical Engineering", "Electrical Engineering", "Chemical Engineering"};
FILE *fp;
...
void rembooks(void)
{
    ...
    if (count == 0)
        ...
        printf("\n\t\tBook entry deleted Successfully!\n");
